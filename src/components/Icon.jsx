...
const ICONS = {
  ...
  globe: (
    <>
      <circle cx="8" cy="8" r="6" />
      <path d="M2.2 8h11.6" />
      <path d="M8 2a9 9 0 0 1 0 12A9 9 0 0 1 8 2z" />
    </>
  ),
  activity: <path d="M1.6 8h2.9l1.8-4.6L8.9 12l1.9-4h3.6" />,
  zap: <path d="M9.2 1.6 3.4 9.2h3.6l-.6 5.2 5.8-7.6H8.6z" />,
  printer: (
    <>
      <path d="M4.4 6.2V2.6h7.2v3.6" />
      <rect x="1.8" y="6.2" width="12.4" height="5" rx="1.1" />
      <path d="M4.4 9.6h7.2v3.8H4.4z" />
      {DOT(12.1, 8.4, 0.7)}
    </>
  ),
  sparkles: (
    <>
      <path d="M5.6 2.2 6.5 5l2.8.9-2.8.9-.9 2.8-.9-2.8L2 5.9 4.7 5z" />
      <path d="M11.4 8.4l.6 1.8 1.8.6-1.8.6-.6 1.8-.6-1.8-1.8-.6 1.8-.6z" />
    </>
  ),
}
